...
<pre style="position: relative;"><strong>Input:</strong> piles = [3,6,7,11], h = 8
<strong>Output:</strong> 4
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> piles = [30,11,23,4,20], h = 5
<strong>Output:</strong> 30
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> piles = [30,11,23,4,20], h = 6
